...
#pragma warning restore CS0067
        ...
        {
            Application.Current.Resources.MergedDictionaries.Add(Application.LoadComponent(new Uri("/LevelEditorPlugin;component/GameSpecific/MirrorsEdgeCatalyst/Themes/Editors/UIWidgetBlueprintEditor.xaml", UriKind.Relative)) as ResourceDictionary);
            Application.Current.Resources.MergedDictionaries.Add(Application.LoadComponent(new Uri("/LevelEditorPlugin;component/GameSpecific/MirrorsEdgeCatalyst/Themes/Editors/ViewModels/UIWidgetLayersInstancesViewModel.xaml", UriKind.Relative)) as ResourceDictionary);
